...
{
    public class WarningsMetric : IMetricCalculator
    {
            ...
            DateTime? lastRun = null)
        {
            ...
            return Task.FromResult<object>(events.OfType<DiagnosticsProduced>().SelectMany(d => d.Diagnostics).Count(d => d.Severity == DiagnosticSeverity.Warning));
        }
    }
}